        ...
        if (calcQuestionMatches) {
            ...
            try {
                ...
                if (question) {
                    ...
                    result =
                        "Berhasil menghapus pertanyaan " + `"${questionHapus}"`;
                } else {
                    result =
                        "Pertanyaan tidak ditemukan atau merupakan pertanyaan bawaan sistem.";
                }
            } catch (_) {
                result = "Internal server error.😶";
            }
